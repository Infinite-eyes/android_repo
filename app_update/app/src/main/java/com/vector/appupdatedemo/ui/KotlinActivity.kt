...
class KotlinActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityKotlinBinding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.apply {

            btnDefault.setSolidTheme()
            btnDiy1.setStrokeTheme()
            btnDiy2.setStrokeTheme()
            btnDiy3.setStrokeTheme()
            btnDiy4.setStrokeTheme()
            btnDiy5.setStrokeTheme()
            btnDefault.setOnClickListener {
                defaultUpdate()
            }
            btnDiy1.setOnClickListener {
                updateDiy1()
            }
            btnDiy2.setOnClickListener {
                updateDiy2()
            }
            btnDiy3.setOnClickListener {
                updateDiy3()
            }
            btnDiy4.setOnClickListener {
                updateDiy4()
            }
            btnDiy5.setOnClickListener {
                updateDiy5()
            }
        }
                ...
                if (isShowDownloadProgress) {
                    updateAppManager.download {
                        ...
                        onProgress { progress, _ ->
                            HProgressDialogUtils.setProgress(
                                Math.round(
                                    progress * 100
                                )
                            )
